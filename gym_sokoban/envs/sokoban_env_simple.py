...
class SimpleSokobanEnv(SokobanEnv):
    ...
    def __init__(self,
        ...
        super(SimpleSokobanEnv, self).__init__(dim_room, max_steps, num_boxes, num_gen_steps)
    ...
    def reset(self, second_player=False, render_mode='rgb_array'):
        ...
        self.room_fixed, self.room_state, self.box_mapping = self.simple_map()
